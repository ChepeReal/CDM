...
export default function App() {
  ...
  const [completedShiftSummary, setCompletedShiftSummary] = useState(null); 
  ...
  const [selectedShiftAdmin, setSelectedShiftAdmin] = useState(null); 
                    ...
                    <table className="w-full text-left text-sm border-collapse bg-white">
                      ...
                      <tbody className="divide-y divide-slate-100">
                        {WOOD_REFERENCES.map(ref => {
                          ...
                          if (initial == 0 && final == 0 && consumed == 0) return null; // Ocultar los que no se usaron
